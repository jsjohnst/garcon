...
Server.prototype.sproutcoreFrameworks = function(options) {
  var opts, key;
  
  if (this._sproutcoreFrameworks === undefined) {    
    opts = { server: this, combineScripts: true };
    for (key in options) {
      opts[key] = options[key];
    }
    
    this._sproutcoreFrameworks = ['bootstrap', 'runtime', 'foundation', 'datastore', 'desktop', 'animation'].map(function(framework) {
