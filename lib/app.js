...
App.prototype.addSproutcore = function(options) {
  this.addFrameworks(this.server.sproutcoreFrameworks(options));
};
  ...
  return function(callback) {
    ...
    if (htmlScripts === undefined) {
      that.frameworks.forEach(function(framework) {
        ...
        if (/bootstrap/.test(framework.path)) {
          html.push('<script type="text/javascript">if (SC.setupBodyClassNames) SC.setupBodyClassNames();</script>');
        }
